...
func GetUserBag(ctx context.Context, uid int64, chapter int) (map[string]interface{}, error) {
	...
	return map[string]interface{}{"uid": uid, "chapter": chapter, "bag": rows}, nil
}

func GetUserBagTp(ctx context.Context, uid int64, chapter int) (map[string]interface{}, error) {

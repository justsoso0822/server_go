...
// LogMsgColumns defines and stores column names for the table log_msg.
...
// logMsgColumns holds the columns for the table log_msg.
var logMsgColumns = LogMsgColumns{
	Id:   "id",
	Uid:  "uid",
	Msg:  "msg",
	Time: "time",

...
type UserItemDao struct {
	...
	columns  UserItemColumns    // columns contains all the column names of Table for convenient usage.
	handlers []gdb.ModelHandler // handlers for customized model modification.
}

// UserItemColumns defines and stores column names for the table user_item.
...
// userItemColumns holds the columns for the table user_item.
...
// NewUserItemDao creates and returns a new DAO object for table data access.
...
func (dao *UserItemDao) DB(ctx context.Context) gdb.DB {

...
type MemConfigDao struct {
	...
	columns  MemConfigColumns   // columns contains all the column names of Table for convenient usage.
	handlers []gdb.ModelHandler // handlers for customized model modification.
}

// MemConfigColumns defines and stores column names for the table mem_config.
...
// memConfigColumns holds the columns for the table mem_config.
...
// NewMemConfigDao creates and returns a new DAO object for table data access.
...
func (dao *MemConfigDao) DB(ctx context.Context) gdb.DB {
